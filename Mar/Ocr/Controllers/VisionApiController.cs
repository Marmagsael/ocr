...
public class VisionApiController : Controller
{
    ...
    public IActionResult VTest()
    {
        string ocrObj = Vtest.OcrObj();

        ViewBag.ocrObj = ocrObj; 
        return View();
    }
    ...
    public IActionResult AnalyzeImage()
    {
        ...
        //Image image = Image.FromFile("/Simpacc/Mar/Ocr/wwwroot/images/bill-meralco.png");
        Image image = Image.FromFile("D:/Development/Web/Simpacc/Mar/Ocr/wwwroot/images/bill-meralco.png");
    ...
    private string DetectAmount(AnnotateImageResponse response)
    {
        ...
        */
        ...
        foreach (var text in textAnnotations)
        {
            ...
            {
                if (keywordIsFound && 
                    minY < keywordBoundingBox["maxY"] && 
                    maxY > keywordBoundingBox["minY"] && 
                    minX > keywordBoundingBox["maxX"])
                {
